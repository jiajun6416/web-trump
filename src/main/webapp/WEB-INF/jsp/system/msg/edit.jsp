		...
		<table style="width:98%;margin-top: 10px;margin-left: 9px;" >
			<tr>
				<td style="margin-top:0px;">
					 <div style="float: left;" style="width:81%"><textarea readonly="readonly" name="USERNAME" id="USERNAME" rows="1" cols="50" style="width:595px;height:32px;" title="这里不能手动修改">${usernames}</textarea></div>
